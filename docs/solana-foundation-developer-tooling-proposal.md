...
- Eight synthetic Drift replay scenarios, including unknown public guardrail pause-bit and observed perp pause-flag cases that are rejected with `DataQualityLow` plus `ExecutionDisabledDryRun`.
