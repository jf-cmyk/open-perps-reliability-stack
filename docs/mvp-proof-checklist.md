...
| Drift is first, Jupiter Perps is second, and Phoenix/Rise is third. | `docs/protocol-targets.md` and decision log. | Manual review of `docs/protocol-targets.md`; Drift shape snapshot, Jupiter target discovery, and Jupiter transaction-history sampling are live, while Drift public-field decode and Jupiter request/fulfillment pairing remain pending. |
