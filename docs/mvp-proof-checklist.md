...
| Jupiter Perps source authority gaps are public and bounded. | `schemas/datasets/jupiter-authority-gap-v0.json`, `examples/public/jupiter-authority-gap-v0/`, `datasets/sample/jupiter_synthetic_lifecycle_candidate_unverified_001/`. | `scripts/validate_public_jupiter_authority_gap.py` validates checksums, DQ gates, repo-relative evidence refs, and no binary-decode/pairing/replay claims. |
