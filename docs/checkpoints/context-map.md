...
1. [Current checkpoint](2026-06-09-worker-and-guardrail-package-checkpoint.md)
...
1. Commit, push, deploy, and smoke-check the worker/guardrail package if not already deployed.
