...
As of the latest Solana research state, the read-only paginator has scanned 288,000 finalized transactions for the legacy Drift program from July 22 back through slot `415592674` at `2026-04-25T15:31:16Z` without finding a log message that matches `Instruction: Liquidate`.
