...
- [Jupiter verified pairing validator](docs/jupiter-verified-pairing-validator.md)
...
- [Railway read-only worker service plan](docs/railway-readonly-worker-service-plan.md)
- [Read-only soak runbook](docs/read-only-soak-runbook.md)
- [Commercial diagnostics brief](docs/commercial-diagnostics-brief.md)
