...
def main():
    ...
    for item in [
        ...
        "Drift legacy liquidation-history diligence has scanned 146,000 finalized program transactions from July 22 back through slot 418153431 on May 7 without a matching Liquidate* log; this is queue progress only, not evidence that liquidations were absent.",
