...
def main():
    ...
    for item in [
        ...
        "Drift legacy liquidation-history diligence has scanned 298,000 finalized program transactions from July 22 back through slot 415423666 at 2026-04-24T20:58:39Z without a matching Liquidate* log; this is queue progress only, not evidence that liquidations were absent.",
