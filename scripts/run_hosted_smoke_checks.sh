...
assert_contains "148,000 finalized transactions" "$workdir/drift-liquidation-scan-boundary.md"
assert_contains "418069879" "$workdir/drift-liquidation-scan-boundary.md"
