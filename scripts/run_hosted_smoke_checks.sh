...
assert_contains "266,000 finalized transactions" "$workdir/drift-liquidation-scan-boundary.md"
assert_contains "415904436" "$workdir/drift-liquidation-scan-boundary.md"
