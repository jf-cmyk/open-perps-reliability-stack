...
assert_contains "308,000 finalized transactions" "$workdir/proof-pack-changelog.md"
...
assert_contains "308,000 finalized transactions" "$workdir/drift-liquidation-scan-boundary.md"
assert_contains "415272972" "$workdir/drift-liquidation-scan-boundary.md"
