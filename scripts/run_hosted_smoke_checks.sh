...
assert_contains "328,000 finalized transactions" "$workdir/proof-pack-changelog.md"
...
assert_contains "328,000 finalized transactions" "$workdir/drift-liquidation-scan-boundary.md"
assert_contains "414754843" "$workdir/drift-liquidation-scan-boundary.md"
